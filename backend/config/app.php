...
return [
    ...
    'default_timezone' => env('APP_DEFAULT_TIMEZONE', 'America/Argentina/Buenos_Aires'),
    'default_currency_code' => env('APP_DEFAULT_CURRENCY_CODE', 'ARS'),
