...
class UpsertProductRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'sale_end_date' => [
                Rule::when(
                    fn() => $this->input('product_type') === ProductType::TICKET->name,
                    ['required', 'date', 'after:sale_start_date'],
                    ['nullable', 'date', 'after:sale_start_date']
                ),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'sale_end_date.required' => __('A sale end date is required for ticket products.'),
        ];
    }
}
