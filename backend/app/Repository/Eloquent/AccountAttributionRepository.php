    ...
    public function getAttributionStats(
        ...
        $query = DB::table('account_attributions as aa')
            ->select([
                ...
                DB::raw('COUNT(DISTINCT CASE WHEN amp.setup_completed_at IS NOT NULL THEN aa.account_id END) as mp_connected'),
            ...
            ->leftJoin('account_mercadopago_platforms as amp', function ($join) {
                $join->on('a.id', '=', 'amp.account_id')
